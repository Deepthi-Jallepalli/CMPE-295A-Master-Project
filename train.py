...
path.append("/home/014489241/fl_project/TensorFlowYOLOv3/")
# path.insert(1,"/home/014489241/fl_project/TensorFlowYOLOv3")
...
def train_client(comm_rounds):
    ...
    if comm_rounds>=1:
        try:
            print("Training from checkpoints")
            yolo.load_weights(f"./checkpoints/{TRAIN_MODEL_NAME}")
            # yolo.load_weights(f"./checkpoints/aggregated_weights.data-00000-of-00001")
        except ValueError:
    ...
    best_val_loss = 2000 # should be large at start
