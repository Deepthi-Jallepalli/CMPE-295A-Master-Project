...
def aggregation():
    ...
    target_dir = '/home/014537055/FL_Project/TensorFlow-2.x-YOLOv3/Clients'
    ...
    yolo.save_weights(f'/home/014537055/FL_Project/TensorFlow-2.x-YOLOv3/server_agg_weights/{TRAIN_MODEL_NAME}')